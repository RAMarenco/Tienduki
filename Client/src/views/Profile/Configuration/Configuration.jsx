...
const Configuration = () => {
    ...
    const addTagPost = (input, social) => {
        fetch(`https://apit.mingo.studio/api/social/`, {
            method: "POST",
            headers: {
    ...
    const removeTags = (indextToRemove, idToRemove) => {
        fetch(`https://apit.mingo.studio/api/social/${idToRemove}`, {
            method: "DELETE",
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const saveChangesFetch = (body) => {
        fetch(`https://apit.mingo.studio/api/user/${outletContext._id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const verifyPassword = async (body) => {
        const get = await fetch("https://apit.mingo.studio/api/auth/verify/", {
            method:"POST",
            crossDomain:true,
            headers:{
                "Content-Type" : "application/json",
